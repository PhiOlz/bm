...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        self.response.write('Post Here : <form method="post">')
        self.response.write('<input type="textarea" name="post"></input>')
        self.response.write('<input type="submit"></input></form>')
        self.response.write('Search & View Post Here : <form method="post><select name="pos">')
